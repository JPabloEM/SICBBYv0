...
<head>
	...
	<title>Bienvenido voluntario</title>
	<style type="text/css">
		p{
			font-family: arial;
			letter-spacing: 1px;
		...
		<tbody>
			...
			<tr>
				<td>
					...
					<p>Bienvenido a nuestro Corredor Biológico Bosques de Yaguarundí</p>
					<p>Ahora puedes participar de nuestras actividades</p>
					<a href="<?= BASE_URL; ?>" target="_blank" class="x_button_link x_link_blue">CBBY</a>
