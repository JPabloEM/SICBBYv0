...
<html lang="es">
  <head>
    <meta charset="utf-8">
    <meta name="description" content="Corredor Biologico Bosques de Yaguarundi">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="CBBY">
    <meta name="theme-color" content="#03505a">
    <link rel="shortcut icon" href="<?= media();?>/images/CBBY.png">
  ...
  <body class="app sidebar-mini">
    ...
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="<?= base_url(); ?>/dashboard"> CBBY</a>
