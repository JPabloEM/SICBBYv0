...
class VoluntarioschkModel extends Mysql
{
	...
	public function insertVoluntariochk(string $identificacion, string $nombre, string $apellido, string $email, string $direccion, int $edad, string $mensaje, string $ocupacion, string $telefono, string $Estado)
	{
		$return = 0;
	...
	public function updateVoluntariochk(int $id, string $identificacion, string $nombre, string $apellido, string $email, string $direccion, int $edad, string $mensaje, string $ocupacion, string $telefono, string $Estado)
	{
		$this->intId = $id;
		$this->strIdentificacion = $identificacion;
		$this->strNombre = $nombre;
