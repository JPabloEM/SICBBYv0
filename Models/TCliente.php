...
trait TCliente
{
	...
	public function setVoluntarioT(string $identificacion_volunteer, string $frist_name_volunteer, string $last_name_volunteer, string $email, string $address_volunteer, string $age_volunteer, string $mensaje, string $ocupation_volunteer, string $phone_number_volunteer)
	{
		...
		//$identificacion_volunteer = $identificacion_volunteer != "" ? $identificacion_volunteer : "";
		//$frist_name_volunteer = $frist_name_volunteer != "" ? $frist_name_volunteer : "";
		//$last_name_volunteer = $last_name_volunteer != "" ? $last_name_volunteer : "";
		//$email = $email != "" ? $email : "";
		//$address_volunteer = $address_volunteer != "" ? $address_volunteer : "";
		//$age_volunteer = $age_volunteer != "" ? $age_volunteer : "";
		//$mensaje = $mensaje != "" ? $mensaje : "";
		//$ocupation_volunteer = $ocupation_volunteer != "" ? $ocupation_volunteer : "";
		//$phone_number_volunteer = $phone_number_volunteer != "" ? $phone_number_volunteer : "";
		...
		if (empty($request)) {
			...
			$query_insert = "INSERT INTO volunteers(identificacion_volunteer,frist_name_volunteer,last_name_volunteer,email,address_volunteer,age_volunteer,mensaje,ocupation_volunteer,phone_number_volunteer) 
						  VALUES(?,?,?,?,?,?,?,?,?)";
			$arrData = array($identificacion_volunteer, $frist_name_volunteer, $last_name_volunteer, $email, $address_volunteer, $age_volunteer, $mensaje, $ocupation_volunteer, $phone_number_volunteer);
			$request_insert = $this->con->insert($query_insert, $arrData);
			return $request_insert;
